...
TEST_CASE("127WordLadder"){
    SECTION("1270"){
        REQUIRE(canTrandform("hit","hot")==true);
        REQUIRE(canTrandform("hit","hop")==false);
        REQUIRE(canTrandform("ait","aot")==true);
    }
    SECTION("1271"){
    ...
    SECTION("1273"){
        ...
        REQUIRE(ladderLength(beginWord,endWord,wordList)==20);
    }
}
